...
const STATIC_ADDRESS = '0x248Dd3836E2A8B56279C04addC2D11F3c2497836';
/**
...
function Login() {
    ...
    // Check NFT Balance
    const checkNFTBalance = async (): Promise<void> => {
        try {
            ...
            // Get balance for static address
            const balance = (await contract.methods
                .balanceOf(STATIC_ADDRESS)
                .call()) as string;
            ...
            setNftBalance(formattedBalance);
        } catch (error) {
            console.error('Error checking NFT balance:', error);
            alert('Error checking NFT balance. Please try again.');
        } finally {
